...
> Rapport des statistiques du **meilleur run** (job `76092`, masquage d'arêtes à 15 %)
> et du contexte comparatif. Toutes les valeurs sont extraites des logs réels
> d'entraînement sur Dalia (GPU B200), pas estimées.
